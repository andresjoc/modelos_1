...
class Engine:
    ...
    def is_in_speed(self, min_speed: int, max_speed: int) -> bool:
        ...
        # Se le agregó un cast a int para evitar errores de comparación
        return int(min_speed) <= int(self.__maximum_speed) <= int(max_speed)
...
class HybridEngine(Engine):
    ...
    def __init__(
        ...
        self.__electric_power = electric_power  # It is really neccesary
